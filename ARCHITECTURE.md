...
- **External Services** — CelesTrak (TLE data), Anthropic Claude API (StarAI), NASA (Earth textures)
...
- **Внешние сервисы** — CelesTrak (TLE-данные), Anthropic Claude API (StarAI), NASA (текстуры Земли)
