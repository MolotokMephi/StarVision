...
SYSTEM_PROMPT = """Ты — StarAI, интеллектуальный ассистент проекта StarVision.
Проект StarVision — цифровой двойник группировки российских кубсатов и малых космических аппаратов.
...
def _fallback_response(user_message: str) -> Dict[str, Any]:
    ...
    if any(w in msg_lower for w in ["привет", "здравствуй", "хай", "hello", "добрый", "здрасте"]):
        return {
            "message": "Привет! ✦ Я StarAI — интеллектуальный ассистент StarVision. "
    ...
    # ── Общий ответ ──────────────────────────────────────
    return {
        "message": "Я StarAI — интеллектуальный ассистент StarVision. Вот что я могу:\n"
