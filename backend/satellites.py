...
RUSSIAN_CUBESATS: List[SatelliteInfo] = [
    ...
    SatelliteInfo(
        ...
        name="НОРБИ-2",
        constellation="Научные",
        purpose="Научные эксперименты",
        mass_kg=8.0,
        form_factor="6U",
        launch_date="2022-04-15",
        status="active",
        tle_line1="1 48851U 22003A   26088.50000000  .00000300  00000-0  18000-3 0  9983",
        tle_line2="2 48851  97.5000 170.0000 0010000  85.0000 275.0000 15.15000000 18000",
        description="Научный спутник для изучения ионосферы и магнитосферы Земли."
    ),
    SatelliteInfo(
        norad_id=40556,
        name="Гонец-М №24",
        ...
        status="active",
        tle_line1="1 40556U 16001A   26088.50000000  .00000060  00000-0  50000-4 0  9985",
        tle_line2="2 40556  82.5200  80.0000 0018000 130.0000 230.0000 14.72000000 55000",
        description="Спутник связи группировки «Гонец-М» — расширение орбитальной плоскости."
    ),
    SatelliteInfo(
        norad_id=55122,
        name="Ресурс-П №4",
        constellation="ДЗЗ",
        purpose="Высокодетальное зондирование",
        mass_kg=6570.0,
        form_factor="Большой КА",
        launch_date="2023-12-25",
        status="active",
        tle_line1="1 55122U 23006A   26088.50000000  .00000080  00000-0  90000-4 0  9984",
        tle_line2="2 55122  97.2800 155.0000 0007000  65.0000 295.0000 15.08000000 14000",
        description="Космический аппарат ДЗЗ серии «Ресурс-П» для сверхвысокодетальной съёмки."
    ),
]
